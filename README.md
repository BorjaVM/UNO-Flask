...
/n
"To run it, you will need to have a venv environment created in the directory."
/n
To create a new environment:/n
<mark> python -m venv venv </mark>
/n
Activate environment (CMD):/n
<mark>.\venv\Scripts\activate</mark>
/n
Install specific libraries:/n
<mark>.\venv\Scripts\pip.exe install flask flask-socketio flask-cors eventlet</mark>
