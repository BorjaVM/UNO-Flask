...
CORS(proyecto1, origins= ["https://gopher-sunny-singularly.ngrok-free.app/"])  # Permite cualquier origen
#CORS(proyecto1, origins= "http://127.0.0.1:5000")
# Variables Globales
barajas = {}
jugadores = {}
sala_host = {}
...
if __name__ == "__main__":
    socketio.run(proyecto1, host='0.0.0.0', port=80, debug=True)
